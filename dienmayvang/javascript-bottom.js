$(document).ready(
    function () {
        ...
        // open-close-search
        // $('#open-close-search').click(
        //     function(){
        //         if( $(this).attr('data-status') == 'close'){
        //             $(this).html('<img src="images/close-button.png" alt=" search">')
        //             $(this).attr('data-status','open');
        //         }
        //         else{
        //             $(this).html('<img src="images/searchIcon.svg" alt=" search">')
        ...
        $(" .item-1.owl-carousel .owl-nav button.owl-prev span").html("<i class='	fa fa-chevron-left'></i>");
        $(" .item-1.owl-carousel .owl-nav button.owl-next span").html("<i class='	fa fa-chevron-right'></i>");
        $('.item-4').owlCarousel({
            loop: false,
            margin: 10,
            dots: false,
